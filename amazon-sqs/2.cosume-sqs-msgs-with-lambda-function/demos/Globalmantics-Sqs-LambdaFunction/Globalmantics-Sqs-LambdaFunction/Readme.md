...
Execute unit tests
```
    cd "Globalmantics-Sqs-LambdaFunction/test/Globalmantics-Sqs-LambdaFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Globalmantics-Sqs-LambdaFunction/src/Globalmantics-Sqs-LambdaFunction"
